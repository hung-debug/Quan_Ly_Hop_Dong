...
@Component({
  selector: 'app-report-eKYC',
  templateUrl: './report-eKYC.component.html',
  styleUrls: ['./report-eKYC.component.scss'],
})

export class ReportEKYCComponent implements OnInit {
  ...
  if (isExport) {
    ...
    const filename = `eKYC_Report_${selectedStartDate + '_' + selectedEndDate}.xlsx`;
