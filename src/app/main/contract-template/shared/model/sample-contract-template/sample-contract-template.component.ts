...
@Component({
  selector: 'app-sample-contract-template',
  templateUrl: './sample-contract-template.component.html',
  styleUrls: ['./sample-contract-template.component.scss']
})
export class SampleContractTemplateComponent implements OnInit, OnDestroy, AfterViewInit  {
  ...
  ngOnInit() {
    ...
    this.datas.contract_user_sign = this.contractTemplateService.objDefaultSampleContract().contract_user_sign;
