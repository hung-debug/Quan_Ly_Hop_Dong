...
@Component({
  ...
  templateUrl: './image-dialog-sign-v2.component.html',
  styleUrls: ['./image-dialog-sign-v2.component.scss']
})
export class ImageDialogSignV2Component implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ImageDialogSignV2Component>
  ) { }
  ...
  t(ev: number) {
    this.typeImageSignatureRadio = ev;
