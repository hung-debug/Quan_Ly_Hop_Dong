  ...
  async onSubmit() {
    ...
    this.contractService.getDetermineCoordination(this.datas.recipientId).subscribe(async (response) => {
      ...
      if (this.isReqCardId && !String(this.myForm.value.card_id)) {
        ...
        (this.isReqCardId && this.myForm.value.card_id && !String(this.myForm.value.card_id).match(parttern.card_id_passport))) {
                  ...
                  try {
                    ...
                    let data = {
                      ...
                      params: {
                        ...
                        maHĐ: this.datas.dataContract.is_data_contract.id,
