...
export class SampleContractFormComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        if (this.datasForm.is_action_contract_created && !this.datasForm.contract_user_sign && (this.router.url.includes("edit"))) {
            ...
            this.datasForm.contract_user_sign = this.contractService.getDataFormatContractUserSign();
        ...
        // } else {
        // this.pdfSrc = Helper._getUrlPdf(this.datasForm.file_content);
        this.pdfSrc = Helper._getUrlPdf(environment.base64FileTest);
        // }
        this.getPage();
        // event drag and drop
