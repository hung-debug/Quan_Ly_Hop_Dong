...
@Component({
  selector: 'app-admin-delete-unit',
  templateUrl: './admin-delete-unit.component.html',
  styleUrls: ['./admin-delete-unit.component.scss']
})
export class AdminDeleteUnitComponent implements OnInit {
  ...
  onSubmit(){
    ...
    this.adminUnitService.deleteUnit(this.data.id).subscribe(
      data => {
