    ...
    stages {
        stage("Build"){
            steps {
                echo '----------------------Start build----------------------'
                sh '''
                  curl -X POST -H "Content-Type: application/json"  -H "x-api-key: AoOK0GLBh+sKwwH1jPAqTV+4ktUbMdxmJ/ly/lNZ168=" -d '{"receivers": [{"email": "quyen.nguyenhuu@mobifone.vn"},{"email": "dat.trinhtien10@mobifone.vn"},{"email": "duong.nguyenhuu@mobifone.vn"},{"email": "thao.phamthi10@mobifone.vn"},{"email": "ha.nguyendo10@mobifone.vn"},{"email": "tu.lehuuanh10@mobifone.vn"},{"email": "truong.vuongtat@mobifone.vn"},{"email": "hong.phamthu@mobifone.vn"},{"email": "vu.vuongtat@mobifone.vn"},{"email": "anh.nguyenkim@mobifone.vn"},{"email": "anh.vunam@mobifone.vn"},{"email": "ha.danghoang@mobifone.vn"},{"email": "khang.buithe10@mobifone.vn"},{"email": "nhu.nguyenthi@mobifone.vn"}],"announcement": "Start build eContract FE dev"}' https://ottchat.mobifone.vn/chat_engine/general/push_announcement
