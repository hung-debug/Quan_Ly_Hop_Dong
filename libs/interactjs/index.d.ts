...
declare module "@interactjs/core/Eventable" {
    import type { ListenersArg, Rect } from "@interactjs/types/index";
...
declare module "@interactjs/core/Interactable" {
    import type { ActionName, Actions, Scope } from "@interactjs/core/scope";
    import type { Context, Element, Target, Listeners, OrBoolean, EventTypes, ListenersArg } from "@interactjs/types/index";
    import { Eventable } from "@interactjs/core/Eventable";
    import type { OptionsArg } from "@interactjs/core/options";
    import { Options } from "@interactjs/core/options";
    ...
    export class Interactable implements Partial<Eventable> {
         ...
         */
        getRect(element: Element): Required<import("@interactjs/types/index").Rect>;
        /**
...
declare module "@interactjs/utils/rect" {
    import type { HasGetRect, RectResolvable, Rect, Point, EdgeOptions } from "@interactjs/types/index";
...
declare module "@interactjs/actions/drag/plugin" {
    ...
    import type { ActionMethod, DraggableOptions } from "@interactjs/types/index";
...
declare module "@interactjs/actions/resize/plugin" {
    ...
    import type { Plugin } from "@interactjs/core/scope";
    import type { ActionMethod, ResizableOptions, FullRect } from "@interactjs/types/index";
...
declare module "@interactjs/modifiers/Modification" {
    ...
    import type { Modifier, ModifierArg, ModifierState } from "@interactjs/modifiers/base";
...
declare module "@interactjs/modifiers/snap/pointer" {
    ...
    import type { ModifierArg, ModifierState } from "@interactjs/modifiers/base";
    ...
    const _default_3: {
        (_options?: Partial<SnapOptions>): import("@interactjs/modifiers/base").Modifier<SnapOptions, SnapState, "snap", {
            target: any;
            inRange: boolean;
            distance: number;
            range: number;
...
declare module "@interactjs/auto-scroll/plugin" {
    import type { Interactable } from "@interactjs/core/Interactable";
    import type Interaction from "@interactjs/core/Interaction";
    import type { ActionName, Plugin } from "@interactjs/core/scope";
    ...
    const autoScroll: {
        ...
        now: () => number;
        interaction: Interaction<keyof import("@interactjs/core/scope").ActionMap>;
        i: number;
        x: number;
        y: number;
        isScrolling: boolean;
        ...
        onInteractionMove<T extends keyof import("@interactjs/core/scope").ActionMap>({ interaction, pointer, }: {
...
declare module "@interactjs/auto-start/base" {
    import type { Interactable } from "@interactjs/core/Interactable";
    import type { Interaction, ActionProps } from "@interactjs/core/Interaction";
    import type { Scope, ActionName, Plugin } from "@interactjs/core/scope";
    import type { CursorChecker, Element } from "@interactjs/types/index";
    module "@interactjs/core/InteractStatic" {
        interface InteractStatic {
...
declare module "@interactjs/core/interactionFinder" {
    ...
    const finder: {
        ...
        simulationResume({ pointerType, eventType, eventTarget, scope }: SearchDetails): Interaction<keyof import("@interactjs/core/scope").ActionMap>;
        mouseOrPen({ pointerId, pointerType, eventType, scope }: SearchDetails): any;
        hasPointer({ pointerId, scope }: SearchDetails): Interaction<keyof import("@interactjs/core/scope").ActionMap>;
        idle({ pointerType, scope }: SearchDetails): Interaction<keyof import("@interactjs/core/scope").ActionMap>;
    };
...
declare module "@interactjs/dev-tools/plugin" {
    ...
    import type { OptionMethod } from "@interactjs/types/index";
    module "@interactjs/core/scope" {
        interface Scope {
            logger: Logger;
        }
...
declare module "@interactjs/snappers/grid" {
    ...
    const _default_13: (grid: GridOptions) => SnapFunction & {
        grid: GridOptions;
...
declare module "@interactjs/modifiers/aspectRatio" {
    ...
    import Modification from "@interactjs/modifiers/Modification";
    import type { Modifier, ModifierModule, ModifierState } from "@interactjs/modifiers/base";
    ...
    const _default_14: {
        ...
        _methods: {
            start: (arg: import("@interactjs/modifiers/base").ModifierArg<AspectRatioState>) => void;
            set: (arg: import("@interactjs/modifiers/base").ModifierArg<AspectRatioState>) => unknown;
            beforeEnd: (arg: import("@interactjs/modifiers/base").ModifierArg<AspectRatioState>) => void | Point;
            stop: (arg: import("@interactjs/modifiers/base").ModifierArg<AspectRatioState>) => void;
        };
    };
...
declare module "@interactjs/modifiers/restrict/pointer" {
    ...
    import type { ModifierArg, ModifierModule, ModifierState } from "@interactjs/modifiers/base";
    ...
    const _default_15: {
        (_options?: Partial<RestrictOptions>): import("@interactjs/modifiers/base").Modifier<RestrictOptions, RestrictState, "restrict", unknown>;
...
declare module "@interactjs/modifiers/restrict/edges" {
    ...
    const _default_16: {
        (_options?: Partial<RestrictEdgesOptions>): import("@interactjs/modifiers/base").Modifier<RestrictEdgesOptions, RestrictEdgesState, "restrictEdges", void>;
...
declare module "@interactjs/modifiers/restrict/rect" {
    const restrictRect: {
        start: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/pointer").RestrictState>) => void;
        set: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/pointer").RestrictState>) => unknown;
    ...
    const _default_17: {
        ...
        _methods: {
            start: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/pointer").RestrictState>) => void;
            set: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/pointer").RestrictState>) => unknown;
            beforeEnd: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/pointer").RestrictState>) => void | import("@interactjs/types").Point;
            stop: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/pointer").RestrictState>) => void;
        };
    };
...
declare module "@interactjs/modifiers/restrict/size" {
    ...
    const _default_18: {
        (_options?: Partial<RestrictSizeOptions>): import("@interactjs/modifiers/base").Modifier<RestrictSizeOptions, RestrictEdgesState, "restrictSize", void>;
...
declare module "@interactjs/modifiers/snap/size" {
    import type { ModifierArg } from "@interactjs/modifiers/base";
    ...
    const _default_19: {
        (_options?: Partial<SnapSizeOptions>): import("@interactjs/modifiers/base").Modifier<SnapSizeOptions, SnapState, "snapSize", {
            target: any;
            inRange: boolean;
            distance: number;
            range: number;
...
declare module "@interactjs/modifiers/snap/edges" {
    import type { ModifierArg, ModifierModule } from "@interactjs/modifiers/base";
    import type { SnapOptions, SnapState } from "@interactjs/modifiers/snap/pointer";
    ...
    const _default_20: {
        (_options?: Partial<SnapEdgesOptions>): import("@interactjs/modifiers/base").Modifier<SnapEdgesOptions, SnapState, "snapEdges", {
            target: any;
            inRange: boolean;
            distance: number;
            range: number;
...
declare module "@interactjs/modifiers/all" {
    const _default_21: {
        aspectRatio: {
            (_options?: Partial<import("@interactjs/modifiers/aspectRatio").AspectRatioOptions>): import("@interactjs/modifiers/base").Modifier<import("@interactjs/modifiers/aspectRatio").AspectRatioOptions, import("@interactjs/modifiers/aspectRatio").AspectRatioState, "aspectRatio", unknown>;
            _defaults: import("@interactjs/modifiers/aspectRatio").AspectRatioOptions;
            _methods: {
                start: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/aspectRatio").AspectRatioState>) => void;
                set: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/aspectRatio").AspectRatioState>) => unknown;
                beforeEnd: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/aspectRatio").AspectRatioState>) => void | import("@interactjs/types").Point;
                stop: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/aspectRatio").AspectRatioState>) => void;
            };
        };
        restrictEdges: {
            (_options?: Partial<import("@interactjs/modifiers/restrict/edges").RestrictEdgesOptions>): import("@interactjs/modifiers/base").Modifier<import("@interactjs/modifiers/restrict/edges").RestrictEdgesOptions, import("@interactjs/modifiers/restrict/edges").RestrictEdgesState, "restrictEdges", void>;
            _defaults: import("@interactjs/modifiers/restrict/edges").RestrictEdgesOptions;
            _methods: {
                start: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/edges").RestrictEdgesState>) => void;
                set: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/edges").RestrictEdgesState>) => void;
                beforeEnd: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/edges").RestrictEdgesState>) => void | import("@interactjs/types").Point;
                stop: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/edges").RestrictEdgesState>) => void;
            };
        };
        restrict: {
            (_options?: Partial<import("@interactjs/modifiers/restrict/pointer").RestrictOptions>): import("@interactjs/modifiers/base").Modifier<import("@interactjs/modifiers/restrict/pointer").RestrictOptions, import("@interactjs/modifiers/restrict/pointer").RestrictState, "restrict", unknown>;
            _defaults: import("@interactjs/modifiers/restrict/pointer").RestrictOptions;
            _methods: {
                start: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/pointer").RestrictState>) => void;
                set: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/restrict/pointer").RestrictState>) => unknown;
        ...
        restrictSize: {
            (_options?: Partial<import("@interactjs/modifiers/restrict/size").RestrictSizeOptions>): import("@interactjs/modifiers/base").Modifier<import("@interactjs/modifiers/restrict/size").RestrictSizeOptions, import("@interactjs/modifiers/restrict/edges").RestrictEdgesState, "restrictSize", void>;
        ...
        snapEdges: {
            (_options?: Partial<import("@interactjs/modifiers/snap/edges").SnapEdgesOptions>): import("@interactjs/modifiers/base").Modifier<import("@interactjs/modifiers/snap/edges").SnapEdgesOptions, import("@interactjs/modifiers/snap/pointer").SnapState, "snapEdges", {
                target: any;
                inRange: boolean;
                distance: number;
                range: number;
            ...
            _methods: {
                start: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/snap/pointer").SnapState>) => void;
                set: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/snap/pointer").SnapState>) => {
                    target: any;
                    inRange: boolean;
                    distance: number;
                    range: number;
                ...
                beforeEnd: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/snap/pointer").SnapState>) => void | import("@interactjs/types").Point;
                stop: (arg: import("@interactjs/modifiers/base").ModifierArg<import("@interactjs/modifiers/snap/pointer").SnapState>) => void;
            };
        };
        snap: {
            (_options?: Partial<import("@interactjs/modifiers/snap/pointer").SnapOptions>): import("@interactjs/modifiers/base").Modifier<import("@interactjs/modifiers/snap/pointer").SnapOptions, import("@interactjs/modifiers/snap/pointer").SnapState, "snap", {
                target: any;
                inRange: boolean;
                distance: number;
                range: number;
        ...
        snapSize: {
            (_options?: Partial<import("@interactjs/modifiers/snap/size").SnapSizeOptions>): import("@interactjs/modifiers/base").Modifier<import("@interactjs/modifiers/snap/size").SnapSizeOptions, import("@interactjs/modifiers/snap/pointer").SnapState, "snapSize", {
                target: any;
                inRange: boolean;
                distance: number;
                range: number;
...
declare module "@interactjs/pointer-events/base" {
    ...
    import type { PerActionDefaults } from "@interactjs/core/options";
    import type { Plugin } from "@interactjs/core/scope";
    import type { Point, PointerType, PointerEventType, Element } from "@interactjs/types/index";
...
declare module "@interactjs/reflow/plugin" {
    import type { Interactable } from "@interactjs/core/Interactable";
    import type { ActionProps, DoAnyPhaseArg } from "@interactjs/core/Interaction";
...
declare module "@interactjs/types/index" {
    ...
    import type _NativePointerEventType from "@interactjs/types/NativePointerEventType";
...
declare module "@interactjs/core/Interaction" {
    ...
    import type { ActionName, Scope } from "@interactjs/core/scope";
...
declare module "@interactjs/core/InteractStatic" {
    ...
    import type { EventTypes, ListenersArg, Target, Element } from "@interactjs/types/index";
...
declare module "@interactjs/core/scope" {
    import type Interaction from "@interactjs/core/Interaction";
    import { Eventable } from "@interactjs/core/Eventable";
    import type { PhaseMap } from "@interactjs/core/InteractEvent";
    import { InteractEvent } from "@interactjs/core/InteractEvent";
    import type { Interactable } from "@interactjs/core/Interactable";
...
declare module "@interactjs/core/tests/_helpers" {
    ...
    export function testEnv<T extends Target = HTMLElement>({ plugins, target, rect, }?: {
        ...
        scope: Scope;
        interaction: import("@interactjs/core/Interaction").Interaction<keyof import("@interactjs/core/scope").ActionMap>;
        target: T;
        ...
        event: {
            ...
            readonly buttons: any;
            preventDefault(): void;
        } & PointerType & import("@interactjs/types/index").PointerEventType;
        interact: import("@interactjs/core/InteractStatic").InteractStatic;
        start: <T_1 extends keyof import("@interactjs/core/scope").ActionMap>(action: ActionProps<T_1>) => boolean;
        stop: () => void;
        down: () => void;
...
declare module "@interactjs/utils/center" {
    import type { Rect } from "@interactjs/types/index";
